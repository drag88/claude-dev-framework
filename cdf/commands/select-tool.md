...
## Usage
```
/cdf:select-tool [operation] [--analyze] [--explain]
```
...
```
/cdf:select-tool "rename function across 10 files" --analyze
...
```
/cdf:select-tool "update console.log to logger.info across project" --explain
...
```
/cdf:select-tool "save project context and discoveries"
