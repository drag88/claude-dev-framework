...
## Overview
Comprehensive Claude Code plugin with 29 commands, 21 agents, 18 skills, and 16 hooks for intelligent development assistance.
...
- `skills/` - 18 auto-invoked behaviors
- `hooks/` - Lifecycle hook configuration (16 hooks)
