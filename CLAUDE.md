...
- `hooks/hooks.json` is the single source of truth for lifecycle hook configuration. Update it whenever you add a script under `scripts/hooks/`.
...
- `skills/` — 22 auto-invoked skill directories (`SKILL.md`)
...
- `rules-templates/` — 15 rule templates including the vendored `claudemd-4-7-rulebook.md`
