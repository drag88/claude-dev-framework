...
> Generate structured implementation workflows from PRDs and feature specifications.

## Quick Start

```bash
# Generate workflow from PRD file
/cdf:workflow docs/feature-spec.md --strategy systematic

# Agile workflow with parallel tasks
/cdf:workflow "user authentication system" --strategy agile --parallel

# Enterprise workflow with validation
/cdf:workflow enterprise-prd.md --strategy enterprise --validate
```

## When to Use

Use `/cdf:workflow` when:
- You have a PRD or feature specification to implement
- Need structured step-by-step implementation planning
...
## Usage
```
/cdf:workflow [prd-file|feature-description] [--strategy systematic|agile|enterprise] [--depth shallow|normal|deep] [--parallel]
```
...
```
/cdf:workflow ClaudeDocs/PRD/feature-spec.md --strategy systematic --depth deep
