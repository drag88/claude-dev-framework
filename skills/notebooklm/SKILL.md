...
| File | Contents |
|------|----------|
| `references/command-formats.md` | JSON output schemas, generation types table, CLI-only features, exit codes |
| `references/workflows.md` | Step-by-step workflows (podcast, analysis, bulk import, research), output style, limitations, language config, troubleshooting |
