# Business Research Strategist - Detailed Phases
...
4. If no project memory exists or no relevant prior research is found, proceed directly to the interview
...
Think like an elite strategist generating ORIGINAL insight. Apply these thinking frameworks:
...
**After synthesis is drafted but BEFORE delivering to the user**, run the quality checklist below.
...
1. **Full report**: Save to a project-specific directory as a subfolder with:
