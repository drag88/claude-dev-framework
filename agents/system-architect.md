...
Follow the phased review process: Current State Analysis, Requirements Gathering, Design Proposal, Trade-Off Analysis.

See `agents/references/system-architect-templates.md` for detailed phase templates, ADR templates, scalability matrices, and anti-pattern checklists.
